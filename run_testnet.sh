...
pm2 start "FUNDED_ADDRESS=nomic1rchnkdpsxzhquu63y6r4j4t57pnc9w8ecxjqll FUNDED_ORAIBTC_AMOUNT=100000000000 nomic start --chain-id oraibtc-local-2"
...
# nomic declare ubLdoka5O+CT5/FsbURrht0ap8wP/u+con0mwF82b+0= 10000000000 0.042 0.1 0.01 10000000000 "Foo Bar" "Foo Bar" JASDHKAJSD "Foo Bar"
